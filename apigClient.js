...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://0n4fbuwfe1.execute-api.eu-west-1.amazonaws.com/v1';
    ...
    apigClient.purchasePost = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var purchasePostRequest = {
            verb: 'post'.toUpperCase(),
            path: pathComponent + uritemplate('/purchase').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(purchasePostRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.purchaseOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var purchaseOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/purchase').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(purchaseOptionsRequest, authType, additionalParams, config.apiKey);
    };
